...
==============================
*/
Route::middleware('auth')->get('/dashboard/{project}/tasks/create', [TaskController::class, 'sendUserList'])
    ->name('task');

Route::middleware('auth')->post('/dashboard/{project}/tasks/create', [TaskController::class, 'store',
])->name('task.store');

Route::middleware('auth')->get('/dashboard/{project}/tasks/{task}', [TaskController::class, 'edit',
])->name('task.edit');

Route::middleware('auth')->put('/dashboard/{project}/tasks/{task}', [TaskController::class, 'update',
])->name('task.update');

Route::middleware('auth')->delete('/dashboard/{project}/tasks/{task}', [TaskController::class, 'destroy',
])->name('task.destroy');
