                        ...
                        <div class="space-y-6 sm:space-y-5">
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <input :value="project?.[0]?.title ?? ''" type="text" name="title" id="project-title" 
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    <textarea :value="project?.[0]?.description ?? ''" id="project-description" name="description" rows="3"
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-5">
                                ...
                                <div class="relative max-w-sm">
                                    ...
                                    <input :value="project?.[0]?.due_date ?? ''" datepicker datepicker-format="yyyy-mm-dd" datepicker-autohide name="due_date" id="due-date"
                                        type="text"
                                        ...
                                        <div class="space-y-1 text-center">
                                            ...
                                            <div class="flex text-sm text-gray-600">
                                                <label for="file-upload"
                                                    ...
                                                    <input :value="project?.[0]?.picture ?? ''" id="file-upload" name="picture" type="file"
                                                        class="sr-only" />
                                                </label>
