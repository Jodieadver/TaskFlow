  ...
  <div class="p-10">
    <div class="mx-auto max-w-7xl pt-4 px-4 sm:px-6 lg:px-8 rounded-2xl border border-gray-200 bg-white shadow-sm">
      ...
      <div class="border-b border-gray-200 px-6 py-5">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900"> Project「{{ props.project.title }}」- Task Details
        </h1>
      ...
      <!-- Body -->
      <form method="POST" :action="`/dashboard/${project.id}/tasks/create`" enctype="multipart/form-data"
        class="px-6 py-6 space-y-6">
        <input type="hidden" name="_token" :value="$page.props.csrf_token">
        <!-- Title -->
        <div>
          <label class="block text-sm font-medium text-gray-700">Task Title</label>
          <input name="title" type="text" placeholder="Redesign the main dashboard" class="mt-1 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-[15px] leading-6
        ...
        <div>
          ...
          <textarea name="description" rows="4"
            ...
            class="mt-1 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-[15px] leading-6
                   placeholder:text-gray-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-100"></textarea>
        </div>
        ...
        <div>
          ...
          <div class="relative max-w-sm">
            <select name="user_id" class="w-full appearance-none rounded-lg border border-gray-300 bg-white px-3 py-2 pr-10 text-[15px]
        ...
        <div>
          ...
          <div class="relative max-w-sm">
            <select name="status" class="w-full appearance-none rounded-lg border border-gray-300 bg-white px-3 py-2 pr-10 text-[15px]
                     focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-100">
        ...
        <div class="flex justify-end">
          <button type="submit" :disabled="submitting" class="inline-flex items-center rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white
